...
var animationConstants = require('./constants');

var ANode = AFRAME.ANode;
var coordinates = AFRAME.utils.coordinates;
var parseProperty = AFRAME.schema.parseProperty;
var registerElement = AFRAME.registerElement;
...
AFRAME.registerSystem('a-animation', {
  tick: function (t) {
    TWEEN.update(t);
  }
});
